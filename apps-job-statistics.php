                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-height-100">
                            <div class="d-flex">
                                ...
                                <div>
                                    <div class="apex-charts" data-colors='["--vz-success" , "--vz-transparent"]'
                                        dir="ltr" id="results_sparkline_charts4"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex">
                                <div class="flex-grow-1 p-3">
                                    ...
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-danger mb-0"> <i
                                                class="ri-arrow-down-line align-middle"></i> 3.24 % </span> vs. previous
                                        month</p>
                                </div>
                                <div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="distributed_treemap"
                                    data-colors='["--vz-primary-rgb, 0.75", "--vz-secondary", "--vz-warning", "--vz-info","--vz-success", "--vz-danger"]'
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card card-height-100">
                            ...
                            <div class="card-body pb-0">
                                <div id="deal-type-charts" data-colors='["--vz-primary", "--vz-info"]'
                                    class="apex-charts" dir="ltr"></div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
