                        ...
                        <div class="card bg-primary" style="background-image: url('assets/images/nft/bg-pattern.png');">
                            <div class="card-body p-4">
                                ...
                                <div class="hstack gap-2">
                                    <a href="apps-nft-create.html" class="btn btn-secondary">Create NFT</a>
                        ...
                        <div class="card explore-box">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.html">Long-tailed Macaque</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card explore-box">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.html">Robotic Body Art</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card explore-box">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.html">Creative Filtered
                                            Portrait</a></h6>
                                </div>
                            </div>
                        </div>
