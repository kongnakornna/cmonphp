        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <img src="assets/images/users/avatar-2.jpg" alt=""
                                    class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                                <a href="pages-profile.php">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="https://img.themesbrand.com/velzon/images/img-3.gif" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
                                <img src="assets/images/users/avatar-8.jpg" alt=""
                                    class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="https://img.themesbrand.com/velzon/images/img-4.gif" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
