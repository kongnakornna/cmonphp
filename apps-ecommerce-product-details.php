                                        ...
                                        <div class="mt-xl-0 mt-5">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div>
                                                        <a href="apps-ecommerce-add-product.php" class="btn btn-light"
                                            ...
                                            <div class="product-content mt-5">
                                                ...
                                                <div class="tab-content border border-top-0 p-4" id="nav-tabContent">
                                                    ...
                                                    <div class="tab-pane fade" id="nav-detail" role="tabpanel"
                                                        ...
                                                        <div>
                                                            <h5 class="font-size-16 mb-3">Tommy Hilfiger Sweatshirt for
                                                                Men (Pink)</h5>
                                                            <p>Tommy Hilfiger men striped pink sweatshirt. Crafted with
