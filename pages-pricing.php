...
<head>
    ...
    <title>Pricing | Velzon - Admin & Dashboard Template</title>
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-lg-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-4 fs-15">Simple pricing. No hidden fees. Advanced features for you
                                business.</p>
                                ...
                                <ul class="nav nav-pills arrow-navtabs plan-nav rounded mb-3 p-1" id="pills-tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link fw-semibold" id="annual-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="false">Annually <span class="badge bg-success">25%
                                                Off</span></button>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xxl-3 col-lg-6">
                        <div class="card pricing-box">
                            <div class="card-body bg-light m-2 p-4">
                                ...
                                <p class="text-muted">Excellent for scalling teams to build culture. Special plan for
                    ...
                    <div class="col-xxl-3 col-lg-6">
                        <div class="card pricing-box ribbon-box right">
                            <div class="card-body bg-light m-2 p-4">
                                ...
                                <p class="text-muted">This plan is for those who have a team alredy and running a large
                                    business.</p>
                                <ul class="list-unstyled vstack gap-3">
                                    <li>
                                        <div class="d-flex">
                            ...
                            <div class="col-lg-4">
                                <div class="card pricing-box">
                                    <div class="card-body p-4 m-2">
                                        ...
                                        <div class="pt-4">
                                            <h2><sup><small>$</small></sup>19 <span
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-4">
                                                <a href="javascript:void(0);"
                                                    class="btn btn-soft-primary w-100 waves-effect waves-light">Sign up
                                                    free</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card pricing-box ribbon-box right">
                                    <div class="card-body p-4 m-2">
                                        ...
                                        <div>
                                            ...
                                            <div class="pt-4">
                                                <h2><sup><small>$</small></sup> 29<span
                                                        class="fs-13 text-muted">/Month</span></h2>
                                            </div>
                                        </div>
                                        <hr class="my-4 text-muted">
                                        <div>
                                            ...
                                            <div class="mt-4">
                                                <a href="javascript:void(0);"
                                                    class="btn btn-primary w-100 waves-effect waves-light">Get
                                                    started</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card pricing-box">
                                    <div class="card-body p-4 m-2">
                                        <div>
                                            ...
                                            <div class="pt-4">
                                                <h2><sup><small>$</small></sup> 39<span
                                                        class="fs-13 text-muted">/Month</span></h2>
                                            </div>
                                        </div>
                                        <hr class="my-4 text-muted">
                                        <div>
                                            ...
                                            <div class="mt-4">
                                                <a href="javascript:void(0);"
                                                    class="btn btn-soft-primary w-100 waves-effect waves-light">Get
                                                    started</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card-body h-100">
                                        ...
                                        <div class="text-center plan-btn mt-2">
                                            <a href="javascript:void(0);"
                                                class="btn btn-primary w-sm waves-effect waves-light">Sign up</a>
                                        </div>
                                    </div>
                                </div>
                                <!--end col-->
