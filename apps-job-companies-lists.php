...
<head>
    ...
    <title>Companies List | Velzon - Admin & Dashboard Template</title>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-xxl-3 col-sm-6">
                                            <input type="text" class="form-control bg-light border-light"
                                                id="datepicker" data-date-format="d M, Y" placeholder="Select date">
                                        </div>
                                        <!--end col-->
                    ...
                    <div class="col-xxl-3">
                        <div class="card" id="company-overview">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-4 overview-companydesc">The IT department of a company ensures
                                    that the network of computers within the organisation are well-connected and
                                    functioning properly. All the other departments within the company rely on them to
                                    ensure that their respective functions can go on seamlessly.</p>
                        ...
                        <div class="card overflow-hidden shadow-none card-border-effect-none border-0">
                            ...
                            <div
                                class="card-body bg-soft-danger border-top border-danger border-opacity-25 border-top-dashed">
