                            ...
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted">At Website Name, accessible at Website.com, one of our
                                            main priorities is the privacy of our visitors. This Privacy Policy document
                                            contains types of information that is collected and recorded by Website Name
                                            and how we use it.</p>
                                        <p class="text-muted">If you have additional questions or require more
                                            information about our Privacy Policy, do not hesitate to contact us through
                                            email at Email@Website.com</p>
                                        <p class="text-muted">This privacy policy applies only to our online activities
                                        ...
                                        <ul class="text-muted">
                                            ...
                                            <li>
                                                <p>It uses a dictionary of over 200 Latin words, combined with a handful
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted">If you contact us directly, we may receive additional
                                        ...
                                        <p class="text-muted">Communicate with you, either directly or through one of
                                        ...
                                        <p class="text-muted">When you register for an Account, we may ask for your
                                            contact information, including items such as name, company name, address,
                                            email address, and telephone number.</p>
                                        <p class="text-muted">We use the information we collect in various ways,
                                            including to:</p>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <p class="text-muted">Some of advertisers on our site may use cookies and web
                                        ...
                                        <p class="text-muted"><b>Website Name's Privacy Policy does not apply to other
                                                ...
                                                these Privacy Policies and their links here: Privacy Policy Links.</b>
                                        </p>
                                    </div>
                                </div>
