...
<head>
    ...
    <title>Wallet Connect | Velzon - Admin & Dashboard Template</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted fs-13">WalletConnect is a convenient open source tool that enables a
                                mobile wallet to easily connect to decentralized web applications, and interact with
                                them from your phone.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card text-center">
                            <div class="card-body py-5 px-4">
                                ...
                                <p class="text-muted pb-1">Coinbase Wallet is a software product that gives you access
                                    to a wide spectrum.</p>
                                <a href="#!" class="btn btn-soft-primary">Connect Wallet</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card text-center">
                            <div class="card-body py-5 px-4">
                                ...
                                <h5>Binance</h5>
                                <p class="text-muted pb-1">Binance offers a relatively secure, versatile way to invest
                                    in and trade cryptocurrencies.</p>
                                <a href="#!" class="btn btn-soft-primary">Connect Wallet</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="card text-center">
                            <div class="card-body py-5 px-4">
                                ...
                                <h5>Enjin Wallet</h5>
                                <p class="text-muted pb-1">Enjin is a store of value that can be used in the
                                    non-fungible token (NFT) marketplace.</p>
                                <a href="#!" class="btn btn-soft-primary">Connect Wallet</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="card text-center">
                            <div class="card-body py-5 px-4">
                                ...
                                <h5>Alpha Wallet</h5>
                                <p class="text-muted pb-1">AlphaWallet uses the TokenScript framework, which makes
                                    tokens become “smart”.</p>
                                <a href="#!" class="btn btn-soft-primary">Connect Wallet</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card text-center">
                            <div class="card-body py-5 px-4">
                                ...
                                <p class="text-muted pb-1">Math DApp Factory gives users tools that can simplify the
                                    development of exchanges, games</p>
                                <a href="#!" class="btn btn-soft-primary">Connect Wallet</a>
                            </div>
                        </div>
                    </div>
