                ...
                <div class="row">
                    <div class="col-xxl-9">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div
                                        ...
                                        <button type="button" class="btn btn-soft-primary timeline-btn btn-sm"
                                            id="one_month">
                                            1M
                                        </button>
                                        <button type="button" class="btn btn-soft-primary timeline-btn btn-sm"
                            ...
                            <div class="card-body">
                                <div>
                                    <div id="area_chart_datetime" data-colors='["--vz-primary"]' class="apex-charts"
                                        dir="ltr"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flexshrink-0">
                                <button class="btn btn-primary btn-sm"><i class="ri-star-line align-bottom"></i> Add
                                    Watchlist</button>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive table-card">
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light text-muted">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="current_value" scope="col">Current Value
                                                </th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="returns_per">
                                                    <h6 class="text-danger fs-13 mb-0"><i
                                                            class="mdi mdi-trending-down align-middle me-1"></i>3.42%
                                                    </h6>
                                                </td>
                                            </tr>
                                            <!--end tr-->
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <img src="assets/images/svg/crypto-icons/xrp.svg" alt=""
                                                            class="avatar-xxs me-2" />
                                                        <a href="javascript:void(0)" class="currency_name">Ripple
                                                            (XRP)</a>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <img src="assets/images/svg/crypto-icons/xmr.svg" alt=""
                                                            class="avatar-xxs me-2" />
                                                        <a href="javascript:void(0)" class="currency_name">Monero
                                                            (XMR)</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="returns_per">
                                                    <h6 class="text-danger fs-13 mb-0"><i
                                                            class="mdi mdi-trending-down align-middle me-1"></i>1.92%
                                                    </h6>
                                                </td>
                                            </tr>
                                            <!--end tr-->
                                            <tr>
                                                ...
                                                <td class="returns_per">
                                                    <h6 class="text-danger fs-13 mb-0"><i
                                                            class="mdi mdi-trending-down align-middle me-1"></i>0.87%
                                                    </h6>
                                                </td>
                                            </tr>
                                            <!--end tr-->
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <img src="assets/images/svg/crypto-icons/aave.svg" alt=""
                                                            class="avatar-xxs me-2" />
                                                        <a href="javascript:void(0)" class="currency_name">Aave
                                                            (AAVE)</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <img src="assets/images/svg/crypto-icons/mkr.svg" alt=""
                                                            class="avatar-xxs me-2" />
                                                        <a href="javascript:void(0)" class="currency_name">Maker
                                                            (MKR)</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <img src="assets/images/svg/crypto-icons/yfi.svg" alt=""
                                                            class="avatar-xxs me-2" />
                                                        <a href="javascript:void(0)" class="currency_name">Yearn.finance
                                                            (YFI)</a>
                                                    </div>
                                                </td>
                                    ...
                                    <div class="noresult" style="display: none">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mb-0">We've searched more than 150+ Currencies We did
                                                not find any Currencies for you search.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xxl-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <a href="apps-crypto-transactions.php" class="btn btn-soft-primary w-100">View All
