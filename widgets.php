                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-height-100">
                            <div class="card-body">
                                ...
                                <a href="#!">
                                    <h6 class="fs-15 fw-semibold">Marketing Director <span class="text-muted fs-13">(2-4
                                            Yrs Exp.)</span></h6>
                                </a>
                                <p class="text-muted mb-0"><i class="ri-building-line align-bottom"></i> Themesbrand
                                    <span class="ms-2"><i class="ri-map-pin-2-line align-bottom"></i> California</span>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-height-100">
                            <div class="d-flex">
                                <div class="flex-grow-1 p-3">
                                    ...
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i
                                                class="ri-arrow-up-line align-middle"></i> 34.24 % </span> vs. previous
                                        month</p>
                                </div>
                                <div>
                        ...
                        <div class="card card-height-100">
                            <div class="d-flex">
                                <div class="flex-grow-1 p-3">
                                    ...
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i
                                                class="ri-arrow-up-line align-middle"></i> 6.67 % </span> vs. previous
                                        month</p>
                                </div>
                                <div>
                                    <div class="apex-charts" data-colors='["--vz-success" , "--vz-transparent"]'
                                        ...
                                        <div class="swiper-slide" style="max-width: 200px;">
                                            <div>
                                                ...
                                                <div class="pt-3">
                                                    <h5 class="text-secondary">$99.94</h5>
                                                    <a href="#!">
                                                        <h6 class="fs-15 lh-base text-truncate mb-0">Fabric Dual Tone
                                                            Living Room Chair</h6>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide" style="max-width: 200px;">
                                            <div>
                                                ...
                                                <div class="pt-3">
                                                    <h5 class="text-secondary">$99.94</h5>
                                                    <a href="#!">
                                                        <h6 class="fs-15 lh-base text-truncate mb-0">Crux Motorsports
                                                            Helmet</h6>
                                                    </a>
                                                </div>
                                            </div>
                        ...
                        <div class="card card-height-100">
                            <div class="card-body">
                                ...
                                <p class="text-muted pb-1">If you couldn't relate to the information in the previous
                                    point, you might be looking for the singlet T-shirt, which is also known as the half
                                    T-shirt.</p>
                                        ...
                                        <label class="form-check-label" for="listGroupRadioGrid1">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar-xs">
                                                        <div
                                                            class="avatar-title bg-soft-success text-success fs-18 rounded">
                                        ...
                                        <label class="form-check-label" for="listGroupRadioGrid3">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar-xs">
                                                        <div
                                                            class="avatar-title bg-soft-danger text-danger fs-18 rounded">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <div class="d-none candidate-position">Marketing Director
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
