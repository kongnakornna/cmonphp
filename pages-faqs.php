        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div
                            class="card rounded-0 bg-soft-primary mx-n4 mt-n4 border-top border-0 card-border-effect-none">
                            <div class="px-4">
                                <div class="row">
                                    <div class="col-xxl-5 align-self-center">
                                        <div class="py-4">
                                            <h4 class="display-6 coming-soon-text">Frequently asked questions</h4>
                                            <p class="text-primary fs-15 mt-3">If you can not find answer to your
                                            ...
                                            <div class="hstack flex-wrap gap-2">
                                                <button type="button" class="btn btn-primary btn-label rounded-pill"><i
                                                    ...
                                                    Email Us</button>
                                                <button type="button"
                                                    class="btn btn-secondary btn-label rounded-pill"><i
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="genques-collapseOne" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    existing European languages. It will be as simple their most common
                                                    words.
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="genques-collapseThree" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    pleasures, or else he endures pains to avoid worse pains.But I must
