                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="hstack gap-3 flex-wrap">
                                                            <div><i class="ri-building-line align-bottom me-1"></i>
                                                                Themesbrand</div>
                                                            <div class="vr"></div>
                                                            <div>Create Date : <span class="fw-medium">15 Sep,
                                                                    2021</span></div>
                                                            <div class="vr"></div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="text-muted">
                                                    ...
                                                    <p>It will be as simple as occidental in fact, it will be
                                                    ...
                                                    <div>
                                                        <button type="button" class="btn btn-link link-primary p-0">Read
                                                            more</button>
                                                    </div>
                                                    ...
                                                    <div class="pt-3 border-top border-top-dashed mt-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div>
                                                                    <p class="mb-2 text-uppercase fw-medium">Due Date :
                                                                    </p>
                                                            ...
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div>
                                                                    <p class="mb-2 text-uppercase fw-medium">Priority :
                                                                    </p>
                                                ...
                                                <form class="mt-4">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12 text-end">
                                                            ...
                                                            <a href="javascript:void(0);" class="btn btn-primary">Post
                                                                Comments</a>
                                                        </div>
                                                    </div>
                                                </form>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex flex-wrap gap-2 fs-16">
                                                    <div class="badge fw-medium badge-soft-primary">UI/UX</div>
                                                    <div class="badge fw-medium badge-soft-primary">Figma</div>
                                                    <div class="badge fw-medium badge-soft-primary">HTML</div>
                                                    <div class="badge fw-medium badge-soft-primary">CSS</div>
                                                    <div class="badge fw-medium badge-soft-primary">Javascript</div>
                                                    <div class="badge fw-medium badge-soft-primary">C#</div>
                                                    <div class="badge fw-medium badge-soft-primary">Nodejs</div>
                                                </div>
                                            </div>
                                            <!-- end card body -->
                                        </div>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="ms-3 flex-grow-1">
                                                                            <h5 class="fs-14 mb-0"><a
                                                                                    href="javascript:void(0);"
                                                                                    class="text-dark">Tour-video.mp4</a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="ms-3 flex-grow-1">
                                                                            <h5 class="fs-14 mb-0"><a
                                                                                    href="javascript:void(0);"
                                                                                    class="text-dark">Velzon-logo.png</a>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                            ...
                                            <div class="acitivity-item py-3 d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="mb-1">Nancy Martino <span
                                                            class="badge bg-soft-secondary text-primary align-middle">In
                                                            Progress</span></h6>
                                            ...
                                            <div class="acitivity-item py-3 d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p class="text-muted mb-2">They all have something to say beyond the
                                                        words on the page. They can come across as casual or neutral,
                                                        exotic or graphic. </p>
                                            ...
                                            <div class="acitivity-item d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p class="text-muted mb-2">User <span
                                                            class="text-primary">Erica245</span> submitted a ticket.</p>
                                        ...
                                        <div class="card-body px-4">
                                            <div class="row align-items-center team-row">
                                                ...
                                                <div class="col-lg-2 col">
                                                    <div class="text-end">
                                                        <a href="pages-profile.php" class="btn btn-light view-btn">View
                                                            Profile</a>
                                                    </div>
                                                </div>
                                            </div>
