...
<head>
    ...
    <title>Job Overview | Velzon - Admin & Dashboard Template</title>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="hstack gap-3 flex-wrap">
                                                            ...
                                                            <div><i class="ri-map-pin-2-line align-bottom me-1"></i>
                                                                Zuweihir, UAE</div>
                                                            <div class="vr"></div>
                                                            <div>Post Date : <span class="fw-medium">15 Sep, 2021</span>
                                                            </div>
                                                            <div class="vr"></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-2">A Product Designer of a company is responsible for the user
                                    experience of a product, which usually includes taking direction on the business
                                    goals and objectives from product management. Product Designers are typically
                                    associated with the visual or tactile aspects of a product but sometimes they can
                                    also play a role in the information architecture and system design of a product.</p>
                                <p class="text-muted mb-4">Product designer is an exceptional career choice. The demand
                                    for product designers is increasing with each passing day but there is a huge
                                    shortage for a skilful product designer in the market. With hard work and an apt
                                    skill set, a product designer can make a handsome amount of money.</p>
                                <div>
                                    ...
                                    <ul class="text-muted vstack gap-2">
                                        <li>
                                            To visualise and create drawings and design concepts to determine the best
                                            product.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            To coordinate with team members and to ensure accurate efficiency in the
                                            design phase.
                                        </li>
                                ...
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="#!" class="btn btn-icon btn-soft-info"><i
                                                class="ri-facebook-line"></i></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="#!" class="btn btn-icon btn-soft-success"><i
                                                class="ri-whatsapp-line"></i></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="#!" class="btn btn-icon btn-soft-secondary"><i
                                                class="ri-twitter-line"></i></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="#!" class="btn btn-icon btn-soft-danger"><i
