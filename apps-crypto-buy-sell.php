                                        ...
                                        <div class="col-6">
                                            <div class="d-flex flex-wrap gap-4 align-items-center">
                                                <div>
                                                    ...
                                                    <p class="text-muted text-uppercase fw-medium mb-0">Bitcoin (BTC)
                        ...
                        <div class="table-responsive table-card">
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">We've searched more than 150+ Currencies We did not find
                                        any Currencies for you search.</p>
                                </div>
                            </div>
                        </div>
