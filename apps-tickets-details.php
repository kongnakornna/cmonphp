                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            <div class="row align-items-center">
                                                ...
                                                <!--end col-->
                                                <div class="col-md">
                                                    <h4 class="fw-semibold" id="ticket-title">#VLZ135 - Create an
                                                        Excellent UI for a Dashboard</h4>
                                                    <div class="hstack gap-3 flex-wrap">
                                                        ...
                                                        <div class="badge rounded-pill bg-info fs-12"
                                                            id="ticket-status">New</div>
                                                        <div class="badge rounded-pill bg-danger fs-12"
                                                            id="ticket-priority">High</div>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
                                        ...
                                        <div class="col-md-auto mt-md-0 mt-4">
                                            <div class="hstack gap-1 flex-wrap">
                                                ...
                                                <button type="button" class="btn py-0 fs-16 text-body"
                                                    id="settingDropdown" data-bs-toggle="dropdown">
                    ...
                    <div class="col-xxl-9">
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted">It would also help to know what the errors are - it could be
                                    something simple like a message saying delivery is not available which could be a
                                    problem with your shipping templates. Too much or too little spacing, as in the
                                    example below, can make things unpleasant for the reader. The goal is to make your
                                    text as comfortable to read as possible. On the note of consistency, color
                                    consistency is a MUST. If you’re not trying to create crazy contrast in your design,
                                    then a great idea would be for you to use a color palette throughout your entire
                                    design. It will subconsciously interest viewers and also is very pleasing to look
                                    at. <a href="javascript:void(0);"
                                        class="link-primary text-decoration-underline">Example</a></p>
                                    ...
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-flex mt-4">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-13">Alexis Clarke <small class="text-muted">22 Dec
