                ...
                <div class="row">
                    <div class="col-xxl-3">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="mb-4">
                                    <select class="form-control" name="choices-single-default" data-choices
                                ...
                                <div class="text-muted">
                                    ...
                                    <div class="pt-3 border-top border-top-dashed mt-4">
                                        ...
                                        <div class="hstack flex-wrap gap-2 fs-15">
                                            ...
                                            <div class="badge fw-medium badge-soft-primary">Dashboard</div>
                                            <div class="badge fw-medium badge-soft-primary">Design</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                            <div class="d-flex mb-4">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-13"><a href="pages-profile.php">Joseph Parker</a>
                                                    ...
                                                    <div class="d-flex mt-4">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="fs-13"><a href="pages-profile.php">Tonya
                                                                    Noble</a> <small class="text-muted">22 Dec 2021 -
                                                                    02:32PM</small></h5>
                                            ...
                                            <div class="d-flex mb-4">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-13"><a href="pages-profile.php">Thomas Taylor</a>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-13"><a href="pages-profile.php">Tonya Noble</a>
                                                    ...
                                                    <div class="d-flex mt-4">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="fs-13"><a href="pages-profile.php">Nancy
                                                                    Martino</a> <small class="text-muted">8 sec
                                                                    ago</small></h5>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="assets/images/users/avatar-10.jpg" alt=""
                                                                    class="rounded-circle avatar-xxs">
                                                                <div class="flex-grow-1 ms-2">
                                                                    <a href="pages-profile.php" class="fw-medium">Tonya
                                                                        Noble</a>
                                                                </div>
                                                            </div>
                                                        </td>
